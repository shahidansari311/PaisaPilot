  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingTop: 48, paddingBottom: 12, backgroundColor: theme.card, borderBottomWidth: 1, borderBottomColor: theme.border }}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 18, fontWeight: '900', color: theme.ink, letterSpacing: -0.5 , fontFamily: 'Outfit_700Bold'}}>Monthly Budget 🎯</Text>
          <Text style={{ fontSize: 11, fontWeight: '600', color: theme.muted, marginTop: 2 , fontFamily: 'Inter_500Medium'}}>{monthLabel(currentMonthKey())}</Text>
        </View>
        {budget && !editing && (
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
        ...
        {(!budget || editing) && (
          <View style={{ backgroundColor: theme.card, borderRadius: 16, padding: 14, marginBottom: 16, borderWidth: 2, borderColor: theme.primary + '40' }}>
            <Text style={{ fontSize: 14, fontWeight: '900', color: theme.ink, marginBottom: 12 , fontFamily: 'Outfit_700Bold'}}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: theme.surface, borderRadius: 16, padding: 12, borderWidth: 1, borderColor: theme.border, marginBottom: 16 }}>
              <Text style={{ fontSize: 20, fontWeight: '900', color: theme.primary, marginRight: 8 , fontFamily: 'Outfit_700Bold'}}>₹</Text>
              <TextInput
            ...
            <View style={{ flexDirection: 'row', gap: 12 }}>
              {editing && (
                <TouchableOpacity onPress={() => { setEditing(false); setInputAmount(''); }} activeOpacity={0.7}
                  ...
                  <Text style={{ color: theme.muted, fontWeight: '700', fontSize: 13 , fontFamily: 'Inter_700Bold'}}>Cancel</Text>
                </TouchableOpacity>
              )}
              <TouchableOpacity onPress={saveBudget} activeOpacity={0.85}
                ...
                >
                  ...
                  <Text style={{ color: '#fff', fontWeight: '900', fontSize: 13 , fontFamily: 'Outfit_700Bold'}}>Save Budget</Text>
                </LinearGradient>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <>
            ...
            <View style={{ backgroundColor: theme.card, borderRadius: 16, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: theme.border }}>
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
                <View>
                  <Text style={{ fontSize: 10, fontWeight: '800', color: theme.muted, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 4 , fontFamily: 'Outfit_700Bold'}}>Monthly Budget</Text>
                  <Text style={{ fontSize: 24, fontWeight: '900', color: theme.ink, fontVariant: ['tabular-nums'] , fontFamily: 'Outfit_700Bold'}}>
                ...
                <View style={{ backgroundColor: theme.primary + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 16 }}>
                  <Text style={{ fontSize: 11, fontWeight: '800', color: theme.primary , fontFamily: 'Outfit_700Bold'}}>
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                <View style={{ flex: 1, backgroundColor: theme.danger + '12', borderRadius: 12, padding: 10 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 4 }}>
                    ...
                    <Text style={{ fontSize: 9, fontWeight: '800', color: theme.danger, textTransform: 'uppercase' , fontFamily: 'Outfit_700Bold'}}>Spent</Text>
                  </View>
                  <Text style={{ fontSize: 14, fontWeight: '900', color: theme.danger, fontVariant: ['tabular-nums'] , fontFamily: 'Outfit_700Bold'}}>
                ...
                <View style={{ flex: 1, backgroundColor: (isOverBudget ? theme.danger : theme.success) + '12', borderRadius: 12, padding: 10 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 4 }}>
                    ...
                    <Text style={{ fontSize: 9, fontWeight: '800', color: isOverBudget ? theme.danger : theme.success, textTransform: 'uppercase' , fontFamily: 'Outfit_700Bold'}}>
                      {isOverBudget ? 'Over' : 'Left'}
                    </Text>
                  </View>
                  <Text style={{ fontSize: 14, fontWeight: '900', color: isOverBudget ? theme.danger : theme.success, fontVariant: ['tabular-nums'] , fontFamily: 'Outfit_700Bold'}}>
                ...
                <View style={{ flex: 1, backgroundColor: theme.success + '12', borderRadius: 12, padding: 10 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 4 }}>
                    ...
                    <Text style={{ fontSize: 9, fontWeight: '800', color: theme.success, textTransform: 'uppercase' , fontFamily: 'Outfit_700Bold'}}>Income</Text>
                  </View>
                  <Text style={{ fontSize: 14, fontWeight: '900', color: theme.success, fontVariant: ['tabular-nums'] , fontFamily: 'Outfit_700Bold'}}>
              ...
              {isOverBudget && (
                <View style={{ backgroundColor: theme.danger + '15', borderRadius: 12, padding: 12, marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                  <Text style={{ fontSize: 16 , fontFamily: 'Inter_500Medium'}}>⚠️</Text>
                  <Text style={{ flex: 1, fontSize: 12, fontWeight: '700', color: theme.danger, lineHeight: 18 , fontFamily: 'Inter_700Bold'}}>
            ...
            {!isOverBudget && remaining > 0 && (() => {
              ...
              return (
                <View style={{ backgroundColor: theme.success + '12', borderRadius: 16, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: theme.success + '25' }}>
                  <Text style={{ fontSize: 10, fontWeight: '800', color: theme.success, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 4 , fontFamily: 'Outfit_700Bold'}}>Daily Safe Spend</Text>
                  <Text style={{ fontSize: 20, fontWeight: '900', color: theme.success, fontVariant: ['tabular-nums'] , fontFamily: 'Outfit_700Bold'}}>
                    ₹{daily.toLocaleString('en-IN')}<Text style={{ fontSize: 13, fontWeight: '700', opacity: 0.8 , fontFamily: 'Inter_700Bold'}}>/day</Text>
                  </Text>
                  <Text style={{ fontSize: 11, color: theme.success, marginTop: 4, fontWeight: '600' , fontFamily: 'Inter_500Medium'}}>{daysLeft} days remaining this month</Text>
                </View>
              );
            })()}
            ...
            <TouchableOpacity onPress={deleteBudget} activeOpacity={0.7}
              ...
              <Text style={{ color: theme.danger, fontWeight: '700', fontSize: 13 , fontFamily: 'Inter_700Bold'}}>Remove this month's budget</Text>
            </TouchableOpacity>
          </>
        )}
        ...
        {!budget && !editing && (
          <View style={{ backgroundColor: theme.card, borderRadius: 16, padding: 32, alignItems: 'center', borderWidth: 1, borderColor: theme.border, borderStyle: 'dashed' }}>
            <Text style={{ fontSize: 40, marginBottom: 12 , fontFamily: 'Inter_500Medium'}}>🎯</Text>
            <Text style={{ fontSize: 16, fontWeight: '800', color: theme.ink, marginBottom: 8, textAlign: 'center' , fontFamily: 'Outfit_700Bold'}}>No budget set yet</Text>
