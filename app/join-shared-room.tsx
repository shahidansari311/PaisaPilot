...
export default function JoinSharedRoom() {
  ...
  const copyCode = async () => {
    ...
    try {
      ...
      Alert.alert('Copied! 📋', `Room code "${createdCode}" copied to clipboard. Share it with your roommate!`);
    } catch {
      // Clipboard might not be available
      Alert.alert('Room Code', createdCode);
    }
  };
    ...
    return (
      <View style={{ flex: 1, backgroundColor: bg }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 56, paddingBottom: 16, backgroundColor: card, borderBottomWidth: 1, borderBottomColor: border }}>
          ...
          <Text style={{ fontSize: 20, fontWeight: '900', color: ink }}>Room Created! 🎉</Text>
        </View>
        <ScrollView contentContainerStyle={{ padding: 24, alignItems: 'center', paddingTop: 48 }}>
          ...
          <Text style={{ fontSize: 22, fontWeight: '900', color: ink, textAlign: 'center', marginBottom: 8 }}>
            Your room is ready!
          </Text>
          <Text style={{ fontSize: 14, fontWeight: '600', color: muted, textAlign: 'center', marginBottom: 32, lineHeight: 22 }}>
          ...
          <View style={{ backgroundColor: card, borderRadius: 24, padding: 28, borderWidth: 2, borderColor: primary + '40', marginBottom: 24, width: '100%', alignItems: 'center' }}>
            <Text style={{ fontSize: 11, fontWeight: '800', color: muted, textTransform: 'uppercase', letterSpacing: 2, marginBottom: 12 }}>Room Code</Text>
            <Text style={{ fontSize: 42, fontWeight: '900', color: primary, letterSpacing: 8, fontVariant: ['tabular-nums'] }}>
              {createdCode}
            </Text>
            <Text style={{ fontSize: 13, fontWeight: '600', color: muted, marginTop: 8 }}>{roomName}</Text>
          </View>

          {/* Actions */}
          <View style={{ flexDirection: 'row', gap: 12, width: '100%', marginBottom: 16 }}>
            <TouchableOpacity onPress={copyCode} activeOpacity={0.8}
              style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 16, borderRadius: 16, backgroundColor: raised, borderWidth: 1, borderColor: border }}>
              <Copy size={18} color={ink} />
              <Text style={{ fontWeight: '800', fontSize: 14, color: ink }}>Copy</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={shareCode} activeOpacity={0.8}
              style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 16, borderRadius: 16, backgroundColor: '#25D366' + '15', borderWidth: 1, borderColor: '#25D366' + '30' }}>
              <Text style={{ fontSize: 16 }}>📤</Text>
              <Text style={{ fontWeight: '800', fontSize: 14, color: '#25D366' }}>Share</Text>
            </TouchableOpacity>
          </View>
          ...
          <TouchableOpacity onPress={goToRoom} activeOpacity={0.85}
            ...
            <Text style={{ color: '#fff', fontSize: 16, fontWeight: '900' }}>Open Room →</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
    );
    ...
    return (
      <View style={{ flex: 1, backgroundColor: bg }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 56, paddingBottom: 16, backgroundColor: card, borderBottomWidth: 1, borderBottomColor: border }}>
          ...
          <View>
            <Text style={{ fontSize: 20, fontWeight: '900', color: ink }}>Shared Expenses ☁️</Text>
            <Text style={{ fontSize: 12, fontWeight: '600', color: muted, marginTop: 2 }}>Cloud-synced with your roommate</Text>
          </View>
        </View>
        <ScrollView contentContainerStyle={{ padding: 24, paddingTop: 40 }}>
          ...
          <View style={{ alignItems: 'center', marginBottom: 40 }}>
            ...
            <Text style={{ fontSize: 20, fontWeight: '900', color: ink, textAlign: 'center', marginBottom: 8 }}>
              Real-time Expense Sharing
            </Text>
            <Text style={{ fontSize: 14, fontWeight: '600', color: muted, textAlign: 'center', lineHeight: 22 }}>
          ...
          <TouchableOpacity onPress={() => setMode('create')} activeOpacity={0.8}
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 17, fontWeight: '900', color: ink, marginBottom: 4 }}>Create a Room</Text>
              <Text style={{ fontSize: 13, fontWeight: '600', color: muted, lineHeight: 19 }}>
          ...
          <TouchableOpacity onPress={() => setMode('join')} activeOpacity={0.8}
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 17, fontWeight: '900', color: ink, marginBottom: 4 }}>Join a Room</Text>
              <Text style={{ fontSize: 13, fontWeight: '600', color: muted, lineHeight: 19 }}>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 56, paddingBottom: 16, backgroundColor: card, borderBottomWidth: 1, borderBottomColor: border }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: '900', color: ink }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 24 }} keyboardShouldPersistTaps="handled">
        {/* Display Name */}
        <Text style={{ color: muted, fontWeight: '700', marginBottom: 8, fontSize: 13 }}>Your Display Name</Text>
        <TextInput
        ...
        {isCreate && (
          <>
            {/* Room Name */}
            <Text style={{ color: muted, fontWeight: '700', marginBottom: 8, fontSize: 13 }}>Room Name</Text>
            <TextInput
              style={{ backgroundColor: card, borderWidth: 1, borderColor: border, borderRadius: 14, padding: 14, color: ink, fontSize: 16, marginBottom: 20, fontWeight: '600' }}
            ...
            <Text style={{ color: muted, fontWeight: '700', marginBottom: 8, fontSize: 13 }}>Room Code (optional — leave blank for random)</Text>
            ...
            <Text style={{ fontSize: 11, color: muted, fontWeight: '600', marginBottom: 24 }}>
        ...
        {!isCreate && (
          <>
            {/* Enter Room Code */}
            <Text style={{ color: muted, fontWeight: '700', marginBottom: 8, fontSize: 13 }}>Room Code</Text>
            <TextInput
