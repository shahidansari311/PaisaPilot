  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingTop: 48, paddingBottom: 12, backgroundColor: theme.card, borderBottomWidth: 1, borderBottomColor: theme.border }}>
        ...
        <Text style={{ fontSize: 18, fontWeight: '900', color: theme.ink, letterSpacing: -0.5 , fontFamily: 'FjallaOne_400Regular'}}>My Profile 👤</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 20 }}>
          <View style={{ width: 64, height: 64, borderRadius: 32, backgroundColor: theme.primary, alignItems: 'center', justifyContent: 'center', marginBottom: 12, shadowColor: theme.primary, shadowOpacity: 0.35, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } }}>
            <Text style={{ fontSize: 24, fontWeight: '900', color: '#fff' , fontFamily: 'FjallaOne_400Regular'}}>{initials}</Text>
          </View>
          <Text style={{ fontSize: 18, fontWeight: '800', color: theme.ink , fontFamily: 'FjallaOne_400Regular'}}>{name || 'Your Name'}</Text>
          {phone ? <Text style={{ fontSize: 13, fontWeight: '600', color: theme.muted, marginTop: 4 , fontFamily: 'FjallaOne_400Regular'}}>+91 {phone}</Text> : null}
        </View>
        ...
        <View style={{ backgroundColor: theme.primary + '15', borderRadius: 16, padding: 12, marginBottom: 20, borderWidth: 1, borderColor: theme.primary + '30' }}>
          <Text style={{ fontSize: 13, fontWeight: '700', color: theme.primary, lineHeight: 20 , fontFamily: 'FjallaOne_400Regular'}}>
        ...
        <View style={{ marginBottom: 16 }}>
          <Text style={{ fontSize: 10, fontWeight: '800', color: theme.muted, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 8 , fontFamily: 'FjallaOne_400Regular'}}>Your Name</Text>
        ...
        <View style={{ marginBottom: 24 }}>
          <Text style={{ fontSize: 10, fontWeight: '800', color: theme.muted, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 8 , fontFamily: 'FjallaOne_400Regular'}}>Your WhatsApp Number</Text>
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: theme.card, borderRadius: 16, borderWidth: 1, borderColor: theme.border, paddingHorizontal: 12 }}>
            <Text style={{ fontSize: 14, fontWeight: '700', color: theme.muted, marginRight: 8 , fontFamily: 'FjallaOne_400Regular'}}>+91</Text>
            <TextInput
          ...
          <Text style={{ fontSize: 11, color: theme.muted, marginTop: 8, fontWeight: '500' , fontFamily: 'FjallaOne_400Regular'}}>
        ...
        <TouchableOpacity onPress={handleSave} activeOpacity={0.85}
          ...
          >
            ...
            <Text style={{ color: '#fff', fontWeight: '900', fontSize: 15 , fontFamily: 'FjallaOne_400Regular'}}>{saved ? 'Saved! ✅' : 'Save Profile'}</Text>
          </LinearGradient>
        </TouchableOpacity>
