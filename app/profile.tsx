  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg , fontFamily: 'DMSans_500Medium'}}>
      ...
      <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
        ...
        {/* Avatar */}
        <View style={{ alignItems: 'center', marginBottom: 32 , fontFamily: 'DMSans_500Medium'}}>
          <View style={{ width: 100, height: 100, borderRadius: 50, backgroundColor: primary, alignItems: 'center', justifyContent: 'center', marginBottom: 12, shadowColor: primary, shadowOpacity: 0.35, shadowRadius: 14, shadowOffset: { width: 0, height: 6 } , fontFamily: 'DMSans_500Medium'}}>
        ...
        {/* Info Banner */}
        <View style={{ backgroundColor: primary + '15', borderRadius: 18, padding: 16, marginBottom: 24, borderWidth: 1, borderColor: primary + '30' , fontFamily: 'DMSans_500Medium'}}>
        ...
        <TouchableOpacity onPress={() => router.push('/achievements')} activeOpacity={0.8}
          style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: card, borderRadius: 18, padding: 18, marginBottom: 24, borderWidth: 1, borderColor: '#F59E0B' + '40', shadowColor: '#F59E0B', shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } , fontFamily: 'DMSans_500Medium'}}>
          <View style={{ width: 44, height: 44, borderRadius: 22, backgroundColor: '#F59E0B' + '20', alignItems: 'center', justifyContent: 'center', marginRight: 16 , fontFamily: 'DMSans_500Medium'}}>
        ...
        <View style={{ marginBottom: 18 , fontFamily: 'DMSans_500Medium'}}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: card, borderRadius: 18, borderWidth: 1, borderColor: border, paddingHorizontal: 16 , fontFamily: 'DMSans_500Medium'}}>
            <User size={18} color={muted} style={{ marginRight: 12 , fontFamily: 'DMSans_500Medium'}} />
            <TextInput
              style={{ flex: 1, paddingVertical: 16, color: ink, fontSize: 17, fontWeight: '600' , fontFamily: 'DMSans_500Medium'}}
        ...
        {/* Phone Input */}
        <View style={{ marginBottom: 32 , fontFamily: 'DMSans_500Medium'}}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: card, borderRadius: 18, borderWidth: 1, borderColor: border, paddingHorizontal: 16 , fontFamily: 'DMSans_500Medium'}}>
            ...
            <TextInput
              style={{ flex: 1, paddingVertical: 16, color: ink, fontSize: 17, fontWeight: '600', fontVariant: ['tabular-nums'] , fontFamily: 'SpaceGrotesk_600SemiBold'}}
        ...
        <TouchableOpacity onPress={handleSave} activeOpacity={0.85}
          style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, padding: 18, borderRadius: 22, backgroundColor: saved ? success : primary, shadowColor: saved ? success : primary, shadowOpacity: 0.4, shadowRadius: 12, shadowOffset: { width: 0, height: 6 } , fontFamily: 'DMSans_500Medium'}}>
