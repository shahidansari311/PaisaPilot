  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingTop: 56, paddingBottom: 16, backgroundColor: card, borderBottomWidth: 1, borderBottomColor: border }}>
        ...
        <Text style={{ fontSize: 22, fontWeight: '900', color: ink, letterSpacing: -0.5 }}>My Profile 👤</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 32 }}>
          <View style={{ width: 100, height: 100, borderRadius: 50, backgroundColor: primary, alignItems: 'center', justifyContent: 'center', marginBottom: 12, shadowColor: primary, shadowOpacity: 0.35, shadowRadius: 14, shadowOffset: { width: 0, height: 6 } }}>
            <Text style={{ fontSize: 38, fontWeight: '900', color: '#fff' }}>{initials}</Text>
          </View>
          <Text style={{ fontSize: 20, fontWeight: '800', color: ink }}>{name || 'Your Name'}</Text>
          {phone ? <Text style={{ fontSize: 14, fontWeight: '600', color: muted, marginTop: 4 }}>+91 {phone}</Text> : null}
        </View>

        {/* Info Banner */}
        <View style={{ backgroundColor: primary + '15', borderRadius: 18, padding: 16, marginBottom: 24, borderWidth: 1, borderColor: primary + '30' }}>
          <Text style={{ fontSize: 14, fontWeight: '700', color: primary, lineHeight: 22 }}>
        ...
        <View style={{ marginBottom: 18 }}>
          <Text style={{ fontSize: 11, fontWeight: '800', color: muted, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 12 }}>Your Name</Text>
        ...
        <View style={{ marginBottom: 32 }}>
          <Text style={{ fontSize: 11, fontWeight: '800', color: muted, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 12 }}>Your WhatsApp Number</Text>
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: card, borderRadius: 18, borderWidth: 1, borderColor: border, paddingHorizontal: 16 }}>
            <Text style={{ fontSize: 15, fontWeight: '700', color: muted, marginRight: 8 }}>+91</Text>
            <TextInput
          ...
          <Text style={{ fontSize: 12, color: muted, marginTop: 8, fontWeight: '500' }}>
        ...
        <TouchableOpacity onPress={handleSave} activeOpacity={0.85}
          ...
          <Text style={{ color: '#fff', fontWeight: '900', fontSize: 17 }}>{saved ? 'Saved! ✅' : 'Save Profile'}</Text>
        </TouchableOpacity>
